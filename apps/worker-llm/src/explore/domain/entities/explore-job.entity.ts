...
export class ExploreJob extends Entity<ExploreJobProps> {
  private constructor(props: ExploreJobProps, id: UniqueEntityID) {
    super(props, id);
  }

  static reconstitute(props: ExploreJobProps, id: UniqueEntityID): ExploreJob {
    return new ExploreJob(props, id);
  }
  ...
  start(): Either<DomainError, void> {
    if (this.props.type !== JobType.explore) {
      return left(
